...
export const ICONS = {
  ...
  // замок «защитить версию от ротации» в истории CLAUDE.md (Lucide lock / unlock)
  ...
  paperclip: '<path d="M20 11.5l-8 8a5 5 0 0 1-7.1-7.1l8.5-8.5a3.4 3.4 0 0 1 4.8 4.8l-8.5 8.5a1.8 1.8 0 0 1-2.5-2.5l7.8-7.8"/>',
  'dots-h': '<circle cx="5" cy="12" r="1.5" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.5" fill="currentColor" stroke="none"/><circle cx="19" cy="12" r="1.5" fill="currentColor" stroke="none"/>',
  'list-tree': '<path d="M9 5h11M12 12h8M15 19h5"/><path d="M4.5 4v13.5a1.5 1.5 0 0 0 1.5 1.5h6"/><path d="M6 11.5h4.5"/>',
  ...
  volume: '<path d="M4 9.5h3.2L12 5.5v13l-4.8-4H4z" fill="currentColor" stroke="none"/><path d="M15.8 9.2a4 4 0 0 1 0 5.6"/><path d="M18.4 6.6a7.6 7.6 0 0 1 0 10.8"/>',
  ...
  // оболочка «Графит» (v1.1.199+): подвал боковой карточки, чипы нижней полосы, окно синхронизации
  ...
  bell: '<path d="M6.5 9.5a5.5 5.5 0 0 1 11 0c0 5.5 2.5 7 2.5 7H4s2.5-1.5 2.5-7"/><path d="M10.2 20a2 2 0 0 0 3.6 0"/>',
  ...
  'folder-plus': '<path d="M3 7.5A2.5 2.5 0 0 1 5.5 5H9l2 2h7.5A2.5 2.5 0 0 1 21 9.5v7a2.5 2.5 0 0 1-2.5 2.5h-13A2.5 2.5 0 0 1 3 16.5z"/><path d="M12 10.5v5M9.5 13h5"/>',
