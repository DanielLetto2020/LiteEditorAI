...
Чистое рабочее пространство для написания текстов — все элементы управления убраны в боковые панели, на экране только ваш документ:
- 🤖 **AI-ассистент** — выделите фрагмент текста и попросите переписать, сократить, перевести или улучшить. Локальный агент обработает запрос и заменит выделенное результатом — без API-ключей, всё на вашей машине.
- 🎭 **Роли агента** — создавайте собственные роли: «Редактор», «Юрист», «Переводчик», «Копирайтер» — агент будет работать с текстом в заданном стиле и контексте.
- ∑ **Редактор формул** — полноценная поддержка математических формул (MathJax/KaTeX): вставляйте формулы прямо в текст, палитра символов и живой превью.
- 📂 **Файловое дерево в стиле Obsidian** — боковая панель с быстрым созданием файлов и папок, сортировкой и навигацией по проекту.
