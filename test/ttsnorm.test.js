...
// ведущие нули после точки произносятся: иначе 0.05 звучало как 0,5
has(normalizeForSpeech('Заняло 0.05 с'), 'ноль точка ноль пять', 'ведущий ноль дробной части');
has(normalizeForSpeech('Готово на 99.05%'), 'девяносто девять точка ноль пять процента', 'ведущий ноль в процентах');
has(normalizeForSpeech('Сборка 1,05 МБ'), 'один точка ноль пять мегабайта', 'ведущий ноль с единицей');
has(normalizeForSpeech('Встреча в 10:05'), 'десять ноль пять', 'минуты с ведущим нулём');
has(normalizeForSpeech('Цена 3.0'), 'три точка ноль', 'дробная часть из одного нуля');
