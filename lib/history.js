...
function createHistory(opts) {
  ...
  async function write(dir, names, absFile, content, tag) {
    ...
    await fs.promises.writeFile(path.join(dir, `${now()}-${tag}.snap`), content, 'utf8');
